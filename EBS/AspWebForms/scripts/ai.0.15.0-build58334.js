    ...
    var _InternalLogging = (function() {
      ...
      _InternalLogging.logInternalMessage = function(severity, message) {
        ...
        if (this._messageCount == this.MAX_INTERNAL_MESSAGE_LIMIT) {
          var throttleLimitMessage = this.AiNonUserActionablePrefix +
        ...
        if (storage !== null) {
          try {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(1 /* WARNING */, "Browser failed read of local storage." + Util.dump(e));
          }
        }
        return null;
      };
      Util.setStorage = function(name, data) {
        ...
        if (storage !== null) {
          try {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(1 /* WARNING */, "Browser failed write to local storage." + Util.dump(e));
          }
        }
        return false;
      };
      Util.removeStorage = function(name) {
        ...
        if (storage !== null) {
          try {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(1 /* WARNING */,
                "Browser failed removal of local storage item." + Util.dump(e));
          }
        }
        return false;
      };
      ...
      Util.getSessionStorage = function(name) {
        ...
        if (storage !== null) {
          try {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */,
                "Browser failed read of session storage." + Util.dump(e));
          }
        }
        return null;
      };
      Util.setSessionStorage = function(name, data) {
        ...
        if (storage !== null) {
          try {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */,
                "Browser failed write to session storage." + Util.dump(e));
          }
        }
        return false;
      };
      Util.removeSessionStorage = function(name) {
        ...
        if (storage !== null) {
          try {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */,
                "Browser failed removal of session storage item." + Util.dump(e));
          }
        }
        return false;
      };
  ...
  (function(ApplicationInsights) {
    ...
    var Serializer = (function() {
      ...
      Serializer._serializeObject = function(source, name) {
        ...
        if (!source) {
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(0 /* CRITICAL */,
              "cannot serialize " + name + " because it is null or undefined");
          return output;
        }
        if (source[circularReferenceCheck]) {
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(1 /* WARNING */, "Circular reference detected while serializing: '" + name);
          return output;
        }
        if (!source.aiDataContract) {
          if (name === "measurements") {
            ...
            ApplicationInsights._InternalLogging
              .throwInternalUserActionable(1 /* WARNING */,
                "Attempting to serialize an object which does not implement ISerializable: " + name);
            try {
        ...
        for (var field in source.aiDataContract) {
          ...
          if (isRequired && !isPresent && !isArray) {
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */,
                "Missing required field specification: The field '" +
                field +
                "' on '" +
                name +
                "' is required but not present on source");
            continue;
          }
          var value;
          if (isObject) {
    ...
    (function(Context) {
      ...
      var Device = (function() {
        function Device() {
          ...
          this.locale = (typeof screen !== "undefined" && navigator.browserLanguage)
    ...
    var SamplingScoreGenerator = (function() {
      ...
      SamplingScoreGenerator.getScore = function(envelope) {
        ...
        if (envelope.tags[tagKeys.userId]) {
          score = SamplingScoreGenerator.getSamplingHashCode(envelope.tags[tagKeys.userId]) /
            SamplingScoreGenerator.INT_MAX_VALUE;
        } else if (envelope.tags[tagKeys.operationId]) {
          score = SamplingScoreGenerator.getSamplingHashCode(envelope.tags[tagKeys.operationId]) /
            SamplingScoreGenerator.INT_MAX_VALUE;
        } else {
          score = Math.random();
        }
      ...
      var Sample = (function() {
        function Sample(sampleRate) {
          ...
          if (sampleRate > 100 || sampleRate < 0) {
            ApplicationInsights._InternalLogging
              .throwInternalUserActionable(1 /* WARNING */,
                "Sampling rate is out of range (0..100): '" +
                sampleRate +
        ...
        _SessionManager.prototype.initializeAutomaticSessionWithData = function(sessionData) {
          ...
          try {
            if (params.length > 1) {
              ...
              this.automaticSession.acquisitionDate = this.automaticSession.acquisitionDate > 0
                ? this.automaticSession.acquisitionDate
                : 0;
            }
            if (params.length > 2) {
              ...
              this.automaticSession.renewalDate = this.automaticSession.renewalDate > 0
                ? this.automaticSession.renewalDate
                : 0;
            }
          } catch (e) {
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */,
                "Error parsing ai_session cookie, session will be reset: " + ApplicationInsights.Util.dump(e));
          }
          if (this.automaticSession.renewalDate == 0) {
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(1 /* WARNING */, "AI session renewal date is 0, session will be reset.");
          }
        };
    ...
    var Sender = (function() {
      ...
      Sender.prototype.send = function(envelope) {
        ...
        try {
          ...
          if (!envelope) {
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */, "Cannot send empty telemetry");
            return;
          }
          if (!this._sender) {
            ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */, "Sender was not initialized");
            return;
          }
      ...
      Sender.prototype.triggerSend = function(async) {
        ...
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "Telemetry transmission failed, some telemetry will be lost: " + ApplicationInsights.Util.dump(e));
        }
      };
      ...
      Sender._onError = function(payload, message, event) {
        ApplicationInsights._InternalLogging
          .throwInternalNonUserActionable(1 /* WARNING */, "Failed to send telemetry:\n" + message);
      };
          ...
          DataSanitizer.sanitizeKey = function(name) {
            if (name) {
              ...
              if (name.search(/[^0-9a-zA-Z-._()\/ ]/g) >= 0) {
                ...
                ApplicationInsights._InternalLogging
                  .throwInternalUserActionable(1 /* WARNING */,
                    "name contains illegal characters. Illgeal character have been replaced with '_'. new name: " +
                    name);
              }
          ...
          DataSanitizer.sanitizeException = function(exception) {
            if (exception) {
              if (exception.length > DataSanitizer.MAX_EXCEPTION_LENGTH) {
                ...
                ApplicationInsights._InternalLogging
                  .throwInternalUserActionable(1 /* WARNING */,
                    "exception is too long, iit has been trucated to " +
    ...
    (function(Telemetry) {
      ...
      var _ExceptionDetails = (function(_super) {
        ...
        function _ExceptionDetails(exception) {
          ...
          this.typeName = Telemetry.Common.DataSanitizer
            .sanitizeString(exception.name || ApplicationInsights.Util.NotSpecified);
          this.message = Telemetry.Common.DataSanitizer
            .sanitizeMessage(exception.message || ApplicationInsights.Util.NotSpecified);
    ...
    var TelemetryContext = (function() {
      function TelemetryContext(config) {
        ...
        if (typeof window !== "undefined") {
          this._sessionManager = new ApplicationInsights.Context
            ._SessionManager(config,
              function(sessionState, timestamp) {
                return TelemetryContext._sessionHandler(_this, sessionState, timestamp);
              });
      ...
      TelemetryContext.prototype.track = function(envelope) {
        if (!envelope) {
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(0 /* CRITICAL */, "cannot call .track() with a null or undefined argument");
        } else {
      ...
      TelemetryContext._sessionHandler = function(tc, sessionState, timestamp) {
        ...
        var sessionStateData = new ApplicationInsights.Telemetry.Common
          .Data(ApplicationInsights.Telemetry.SessionTelemetry.dataType, sessionStateTelemetry);
        var sessionStateEnvelope = new ApplicationInsights.Telemetry.Common
          .Envelope(sessionStateData, ApplicationInsights.Telemetry.SessionTelemetry.envelopeType);
    ...
    var AppInsights = (function() {
      ...
      AppInsights.prototype.startTrackPage = function(name) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "startTrackPage failed, page view may not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.stopTrackPage = function(name, url, properties, measurements) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "stopTrackPage failed, page view will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.trackPageView = function(name, url, properties, measurements) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "trackPageView failed, page view will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
          ...
          var handle = setInterval(function() {
              try {
                ...
                if (timeoutReached || timingDataReady) {
                  ...
                  durationMs = ApplicationInsights.Telemetry.PageViewPerformance.getDuration(startTime, +new Date);
                  var pageViewPerformance = new ApplicationInsights.Telemetry
                    .PageViewPerformance(name, url, durationMs, properties, measurements);
                  _this.sendPageViewInternal(name,
                    url,
                    pageViewPerformance.isValid && !isNaN(pageViewPerformance.duration)
                  ...
                  if (pageViewPerformance.isValid) {
                    ...
                    var pageViewPerformanceEnvelope = new ApplicationInsights.Telemetry.Common
                      .Envelope(pageViewPerformanceData,
                        ApplicationInsights.Telemetry.PageViewPerformance
                        .envelopeType);
                ...
                ApplicationInsights._InternalLogging
                  .throwInternalNonUserActionable(0 /* CRITICAL */,
                    "trackPageView failed on page load calculation: " + ApplicationInsights.Util.dump(e));
              }
            },
            100);
        }
      ...
      AppInsights.prototype.startTrackEvent = function(name) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "startTrackEvent failed, event will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.stopTrackEvent = function(name, properties, measurements) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "stopTrackEvent failed, event will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.trackEvent = function(name, properties, measurements) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "trackEvent failed, event will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.trackException = function(exception, handledAt, properties, measurements) {
        try {
          ...
          var exceptionTelemetry = new ApplicationInsights.Telemetry
            .Exception(exception, handledAt, properties, measurements);
          var data = new ApplicationInsights.Telemetry.Common
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "trackException failed, exception will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.trackMetric = function(name, average, sampleCount, min, max, properties) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "trackMetric failed, metric will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.trackTrace = function(message, properties) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(1 /* WARNING */,
              "trackTrace failed, trace will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      ...
      AppInsights.prototype.flush = function() {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "flush failed, telemetry will not be collected: " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.setAuthenticatedUserContext = function(authenticatedUserId, accountId) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(1 /* WARNING */,
              "Setting auth user context failed. " + ApplicationInsights.Util.dump(e));
        }
      };
      AppInsights.prototype.clearAuthenticatedUserContext = function() {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(1 /* WARNING */,
              "Clearing auth user context failed. " + ApplicationInsights.Util.dump(e));
        }
      };
      ...
      AppInsights.prototype._onerror = function(message, url, lineNumber, columnNumber, error) {
        try {
          ...
          ApplicationInsights._InternalLogging
            .throwInternalNonUserActionable(0 /* CRITICAL */,
              "_onerror threw " + exceptionDump + " while logging error, error will not be collected: " + errorString);
        }
      };
      return AppInsights;
    })();
        ...
        if (typeof this._events[name] !== "undefined") {
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(1 /* WARNING */,
              "start" +
              this._name +
              " was called more than once for this event without calling stop" +
              this._name +
              ". key is '" +
              name +
              "'");
        ...
        if (isNaN(start)) {
          ApplicationInsights._InternalLogging
            .throwInternalUserActionable(1 /* WARNING */,
              "stop" +
              this._name +
              " was called without a corresponding start" +
              this._name +
              " . Event name is '" +
              name +
              "'");
    ...
    var Initialization = (function() {
        ...
        if ("onbeforeunload" in window) {
          ...
          if (!Microsoft.ApplicationInsights.Util.addEventHandler("beforeunload", performHousekeeping)) {
            Microsoft.ApplicationInsights._InternalLogging
              .throwInternalNonUserActionable(0 /* CRITICAL */, "Could not add handler for beforeunload");
          }
        }
      };
      Initialization.getDefaultConfig = function(config) {
        ...
        config.autoCollectErrors = (config.autoCollectErrors !== undefined && config.autoCollectErrors !== null)
          ? ApplicationInsights.Util.stringToBoolOrDefault(config.autoCollectErrors)
          : true;
  ...
  try {
    if (typeof window !== "undefined" && typeof JSON !== "undefined") {
      ...
      if (window[aiName] === undefined) {
        Microsoft.ApplicationInsights.AppInsights.defaultConfig = Microsoft.ApplicationInsights.Initialization
          .getDefaultConfig();
      } else {
